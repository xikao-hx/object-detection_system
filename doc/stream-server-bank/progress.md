...
- 验证：
  - `cmake --build stream-server/build` 失败，原因是该目录没有 CMake cache。
  - `cmake --build stream-server/build/Debug` 成功。

## Step 2：删除 service 全局单例死代码
- 状态：已完成
- 完成时间：2026-07-01
- 修改文件：
  - `stream-server/src/media_distribution/rtsp/rtsp_service.h`
  - `stream-server/src/media_distribution/rtsp/rtsp_service.cpp`
  - `stream-server/src/media_distribution/file/file_service.h`
  - `stream-server/src/media_distribution/file/file_service.cpp`
  - `stream-server/src/media_distribution/webrtc/webrtc_service.h`
  - `stream-server/src/media_distribution/webrtc/webrtc_service.cpp`
  - `stream-server/src/media_distribution/wspreview/ws_preview.h`
  - `stream-server/src/media_distribution/wspreview/ws_preview.cpp`
- 完成内容：
...
- 完成时间：2026-07-01
- 修改文件：
  - `stream-server/src/common/h264_nal_parser.h`
  - `stream-server/src/media_distribution/file/file_saver.cpp`
  - `stream-server/src/media_distribution/wspreview/ws_preview.cpp`
  - `stream-server/src/media_distribution/webrtc/webrtc.cpp`
- 完成内容：
